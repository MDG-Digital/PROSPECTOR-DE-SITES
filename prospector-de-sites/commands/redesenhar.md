...
- [ ] **Slug conferido:** para CADA cliente, o nome da pasta `sites/<slug>/` é IDÊNTICO ao `slug` do lead no `prospector.db`. Se divergir, corrija para o slug do banco ANTES de prosseguir — pasta/arquivo com nome diferente do banco quebra os botões PÁGINA/EDITAR SITE do dashboard.
